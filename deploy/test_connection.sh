...
echo "1⃣  Test connexion bastion (ssh.grit.ucsb.edu)..."
...
echo ""
echo "2⃣  Test connexion HPC (hpc.grit.ucsb.edu via ProxyJump)..."
...
echo ""
echo "3⃣  Informations système GRIT..."
ssh -F "$SSH_CONFIG" grit "hostname && whoami && pwd"

echo ""
echo "4⃣  Version R sur GRIT..."
