#!/bin/bash
# Récupère les résultats depuis le cluster GRIT
# Usage: bash deploy/fetch_results.sh [sous-dossier]
# Exemples:
#   bash deploy/fetch_results.sh                    # Tout récupérer
#   bash deploy/fetch_results.sh Resultats          # Récupérer Resultats/
#   bash deploy/fetch_results.sh output_V6          # Récupérer output_V6/
...
if [ -z "$1" ]; then
  ...
  # Récupérer les différents dossiers de résultats
