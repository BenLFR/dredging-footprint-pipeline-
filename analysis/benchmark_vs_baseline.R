...
#
# Usage:
#   Rscript analysis/benchmark_vs_baseline.R
#   Rscript analysis/benchmark_vs_baseline.R [path/to/AIS_data_core.rds]
#
# Why these baselines?
...
# Detect speed column from step3 output schema variants
...
if (is.character(ais[[ref_col]]) || is.factor(ais[[ref_col]])) {
  # Accept both English and French-like labels (dredging / dragage)
