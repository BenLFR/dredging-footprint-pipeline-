...
# Accepte les deux conventions de nommage observées:
...
if(!length(lithology_files)) {
  stop(
    "❌ Aucun fichier avec lithologie trouvé (étape 4).\n",
    "   Patterns testés: ", pat_clean, " ; ", pat_base
  )
}
...
cat("✅ Fichier avec lithologie lu :", basename(lithology_path), "(", nrow(dt_lithology), "lignes)\n")
