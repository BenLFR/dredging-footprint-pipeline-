...
## 7. Stage out scratch outputs and clean temporary storage
...
Use `--dry-run` first if you are adapting the workflow to a new site.
...
- Follow the transfer policy in `deploy/TRANSFER_POLICY.md`.
- Use `deploy/HPC_OPERATIONS_CHECKLIST.md` as the release-time runbook.