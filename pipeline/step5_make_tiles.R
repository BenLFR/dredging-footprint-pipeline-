...
# CORRECTION : Calculer exactement le nombre de tuiles nécessaires
# au lieu de laisser st_make_grid tronquer
...
# Génération de la grille avec dimensions fixes
...
# Calcul des statistiques (surface corrigée)
...
if(length(missing_ids) > 0) {
  cat("⚠️  IDs manquants :", paste(missing_ids, collapse=", "), "\n")
} else {
